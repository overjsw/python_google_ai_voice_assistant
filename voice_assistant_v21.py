...
try:
    ...
    # Define the error handler callback function prototype
    ERROR_HANDLER_FUNC = CFUNCTYPE(None, c_char_p, c_int, c_char_p, c_int, c_char_p)

    def py_error_handler(filename, line, function, err, fmt):
        # This is our custom handler. We simply do nothing to suppress messages.
        pass
    ...
    print("ALSA 라이브러리 오류 메시지를 비활성화했습니다.")
except Exception as e:
    print(f"[경고] ALSA 오류 메시지를 비활성화하는 데 실패했습니다: {e}")
