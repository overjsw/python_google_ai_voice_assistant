...
HISTORY_FILE = "conversation_history.json" # 대화 기록 파일
...
The user's name is {USER_NAME}. Always be friendly and sometimes use their name.
...
# 대화 기록 변수 (load_history 함수에서 초기화)
...
def get_gemini_response(text):
    ...
    try:
        ...
        save_history() # 응답을 받은 후 즉시 기록을 저장합니다.
...
def main():
    ...
    # 이전 대화 기록을 불러오거나 새로 시작합니다.
    load_history()

    # 대화 세션이 새로 시작되었는지 확인합니다.
